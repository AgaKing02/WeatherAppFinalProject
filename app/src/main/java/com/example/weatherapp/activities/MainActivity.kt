...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var nextCity: Button
    ...
    private fun init() {
        ...
        nextCity=findViewById(R.id.nextCity)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nextCity.setOnClickListener{
            ...
            getLocationWeatherDetails(47.751076,-120.740135)
    ...
    private fun manipulateResponse(weatherList: WeatherResponse?) {
        ...
        country.text = weatherList?.sys?.country+" / "+weatherList?.name
        weather.text = weatherList?.weather?.get(0)?.description
        degree.text = (weatherList?.main?.temp?.minus(273)).toString()
        tempMin.text = (weatherList?.main?.temp_min?.minus(273)).toString()
        tempMax.text = (weatherList?.main?.temp_max?.minus(273)).toString()
